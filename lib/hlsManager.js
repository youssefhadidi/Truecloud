...
// Set of file hashes confirmed to be natively browser-playable (H.264 + compatible audio in MP4).
// Populated by the stream route on first probe; checked by the transcode-status route.

...
// Language shown when no preference is known (e.g. a first visit to a share link).
export const DEFAULT_LOCALE = 'fr';
// Dictionary used for keys missing from the active language (the most complete one).

...
function buildHlsArgs(inputPath, outputM3u8, videoCodec, audioCodec, hwaccel, { maxHeight } = {}) {
  ...
  if (hwaccel === 'vaapi') {
    ...
    return ['-vaapi_device', VAAPI_DEVICE, '-i', inputPath, '-vf', vaapiFilter, '-c:v', 'h264_vaapi', ...hlsTail];
  }

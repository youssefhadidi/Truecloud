    ...
    <div className="h-screen bg-gray-50 dark:bg-gray-900 flex flex-col overflow-hidden" onClick={contextMenu.closeContextMenu}>
      ...
      >
        ...
        <div className="mb-4 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
          <button onClick={() => navigation.navigateToBreadcrumb(0)} className="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400">
            <FiHome size={16} />
            <span>Home</span>
          </button>
          {state.currentPath &&
        ...
        <div className="mb-6 flex justify-between items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              className="px-3 py-2 text-sm bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
